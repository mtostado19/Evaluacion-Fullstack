...
/src
  /components - componentes reutilizables
    ...
    - Footer.jsx
  /app
    - store.js - guardamos el store de Redux
  ...
  /utils
    -validations.js
    -helpers.js
  /features - Creamos reducers para manejar Redux
    /tasks
      - taskSlice.js
    /user
      - userSlice.js
    /auth
      -authSlice.js
  /services - Códigos para interactuar con elementos externos a la app
    - taskApi.js
    - userApi.js
    /auth
      - authApi.js
